...
public class ArrayDetail {
	...
	public static void main(String[] args) {
		...
		double[] arr2 = {1.1,2.2,3.3,100};//int->double
		
		//2.数组中元素可以是任何数据类型，包括基本类型和引用类型，但不能混用
		...
		//6.数组的下标必须在指定的范围内使用，否则报：下标越界异常，
		//如：int[] arr = new int[5];则有效下标为 0-4 
		//即数组的下标/索引 最小0 最大 数组长度-1
		System.out.println("====数组arr[4]====");
		int [] arr = new int [5];
